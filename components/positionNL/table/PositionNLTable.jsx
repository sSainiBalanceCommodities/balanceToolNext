...
import styles from './PositionNlTable.module.css'
import { balanceDeltaColumnDef, BalanceDummyData, columnColorConfig } from './PositionNLTableColumns';

const PositionNLTable = () => {
...
export default PositionNLTable;
